		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#openweathermapopenweather-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"openweathermapopenweather-display": {
								"semanticObject": "openweathermapopenweather",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=openweathermap.openweather",
									"url": sap.ui.require.toUrl("openweathermap/openweather")
								}
							}
						}
					}
